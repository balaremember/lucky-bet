...
>>>>>>> e9fe92c3a4daa96ccf0a8760bec0f1a8561f6ab1
/* styles */
...
var update = __webpack_require__(15)("07a20c1c", content, false);
      ...
      _c("nav", { attrs: { id: "navbar" } }, [
        _c(
          ...
          [
            ...
            _vm._v(" "),
            _c("router-link", { attrs: { id: "info", to: "/404" } }, [
              _vm._v("О нас")
            ]),
            _vm._v(" "),
            _c("router-link", { attrs: { id: "jobs", to: "/" } }, [
              _vm._v("Вакансии")
            ]),
            _vm._v(" "),
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(15)("2dd3b8a3", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
